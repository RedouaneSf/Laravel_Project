...
<div class="CarsContainer">
    ...
    @if(session()->has('message'))
        ...
        @endif
    @auth
    <button class="btnAjt"><a href="/car/create" >Ajouter une Voiture</a></button>  
    @endauth
    ...
    <div class="row row-cols-1 row-cols-md-3 g-4">
      ...
      <div class="col">
        <div class="card h-100">
          <img src="src="{{asset('storage/'.$item->image)}}"" class="card-img-top" alt="Skyscrapers"/>
          <div class="card-body">
          ...
          <div class="card-footer">
            ...
            <small class="text-muted"> Status||isDisponible<span class="text text-danger">{{$item->prix}}</span></small>
             <button class="btn bg-warning"> <a href="/car/{{$item->slug}}">Details..</a></button>
          </div>
        </div>
      </div>
